    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homeworkId', models.CharField(default='hwm0000', max_length=20, verbose_name='作业号')),
                ('desc', models.CharField(blank=True, default='无', max_length=400, verbose_name='作业说明')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('panduan_score', models.FloatField(blank=True, default=1, verbose_name='判断分值')),
                ('xuanze_score', models.FloatField(blank=True, default=1, verbose_name='选择分值')),
                ('jianda_score', models.FloatField(blank=True, default=1, verbose_name='简答分值')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('questionType', models.CharField(choices=[('pd', '判断'), ('xz', '选择'), ('jd', '简答')], max_length=2, verbose_name='题目类型')),
                ...
                ('note', models.TextField(default='简答题在此处做答', verbose_name='备注信息')),
                ('boolt', models.TextField(default='正确', verbose_name='判断正误正确选项')),
                ('boolf', models.TextField(default='错误', verbose_name='判断正误错误选项')),
